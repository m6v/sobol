1. Разобраться с кнопкой Tab в виджете vnc. По ней видимо уходит фокус клавиатурного ввода и больше на нее не возвращиется! NB! Глюки с многочисленными повторениями нажатых клавиш проявляются только при запуске vnv внутри другой сессии vnc, не обращать на это внимания! Также при нажатии CapsLock, начинаются проблемы ввода с клавиатуры, но это видимо связано с конфликтами переключения раскладки. Также не отрабатываются нажатия и сочетания с клавишами Ctrl!

2. Убрать функционал WebEngine и откатиться обратно на PyQt
